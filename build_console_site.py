...
<main id="main">
  <section class="hero">
    ...
    </div><div class="board-card" aria-hidden="true"><span>CONSOLE</span><strong>DIAG / REPAIR</strong><small>PlayStation · Xbox · Switch</small></div></div>
  </section>
